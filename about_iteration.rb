...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject allows you to provide a base which you can describe and then perform math on, using the elements of an array
  end
  ...
  #   # code to read 'file'
  # 
  # we would lose some of the formatting, collection of lines
